...
public class PagamentoPixLuzDemonioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_pagamento_pix_luzdemonio); // Layout específico para Luz do Demônio
    ...
    private void mostrarDialogoConfirmacao() {
        ...
        dialog.setContentView(R.layout.dialog_confirmacao_pagamento); // Certifique-se de que este layout está disponível
