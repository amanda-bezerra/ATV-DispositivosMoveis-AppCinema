...
public class FilmeAdaoNegroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.filme_adaonegro); // Usando o layout correto
        ...
        botaoImagem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FilmeAdaoNegroActivity.this, SelecionarHorarioAdaoNegroActivity.class);
